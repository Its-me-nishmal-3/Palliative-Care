...
const PaymentModal: React.FC<PaymentModalProps> = ({ onClose }) => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const res = await fetch('https://thachanattukara-palliative.onrender.com/api/payment/create-order', {
                method: 'POST',
            ...
            const options = {
                ...
                handler: async function (response: any) {
                    // 3. Verify Payment
                    try {
                        const verifyRes = await fetch('https://thachanattukara-palliative.onrender.com/api/payment/verify', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
            ...
            rzp1.on('payment.failed', function (response: any) {
                ...
                fetch('https://thachanattukara-palliative.onrender.com/api/payment/payment-failed', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
