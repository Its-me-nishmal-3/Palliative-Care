...
const UNIT_NAMES = [
    ...
    'കൂരിമുക്ക്', 'മുറിയങ്കണ്ണി', 'തെക്കുംമുറി', 'പൂവ്വത്താണി', 'വെള്ളക്കുന്ന്',
                            ...
                            <div className="relative z-10">
                                ...
                                <AnimatePresence>
                                    {isWelcomeExpanded && (
                                        ...
                                        >
                                            <div className="space-y-4 text-gray-700 leading-relaxed text-base md:text-lg font-malayalam whitespace-pre-line">
                                                <p>
                                                    സ്വാന്തന പരിചരണ രംഗത്ത് തച്ചനാട്ടുകര പാലിയേറ്റീവ് കെയർ സൊസൈറ്റിയുടെ സേവനം നാലുവർഷം പിന്നിടുകയാണ്,
                                                    {"\n\n"}
                                                    200 ലധികം കിടപ്പുരോഗികളുടെ വീടുകളിൽ സ്നേഹ സ്വാന്തനത്തിന്റെയും പരിഗണനയുടെയും നന്മ നിറഞ്ഞ സാന്നിധ്യമായി മാറാൻ നമ്മുടെ പാലിയേറ്റീവിന് കഴിഞ്ഞിട്ടുണ്ട്.
                                                    {"\n\n"}
                                                    രണ്ട് ഹോം കെയർ വാഹനങ്ങളുമായി ഡോക്ടർമാരും പാരാമെഡിക്കൽ സ്റ്റാഫുകളും, വളണ്ടിയർമാരും ഉൾപ്പെടുന്ന തച്ചനാട്ടുകര പാലിയേറ്റീവ് കെയർ സംവിധാനം ആഴ്ച്ചയിൽ ആറു ദിവസവും നമ്മുടെ നാടിൻറെ സമസ്ത മേഖലയിലും സേവനം നടത്തിക്കൊണ്ടിരിക്കുകയാണ്.
                                                    {"\n\n"}
                                                    സകല പ്രതീക്ഷകളും നഷ്ടപ്പെട്ട നിരവധി പേർക്കാണ് നമ്മുടെ ടീം സ്നേഹ സാമിപ്യമായി നിസ്തുല സേവനം നടത്തുന്നത്,
                                                    {"\n"}
                                                    ഒരു ലക്ഷത്തോളം രൂപയാണ് ഒരു മാസം ഈ സംവിധാനങ്ങൾ മുന്നോട്ടുകൊണ്ടു പോകാൻ ഇന്ന് ചിലവ് വരുന്നത്, താങ്കളെപ്പോലുള്ള നല്ല മനസ്സുകളുടെ അകമഴിഞ്ഞ പിന്തുണയാണ് ഈ സംവിധാനത്തെ മുന്നോട്ടു കൊണ്ടുപോകുന്നതിന് ശക്തി നൽകുന്നത്.
                                                    {"\n"}
                                                    നന്മയുടെ പൂക്കാലമായ പുണ്യ റമളാനിൽ തച്ചനാട്ടുകര പാലിയേറ്റീവ് കെയർ സൊസൈറ്റി അതിൻറെ വരും വർഷത്തെ ചിലവുകൾക്കായുള്ള ധനശേഖരണാർത്ഥം ഒരു ഈത്തപ്പഴ ചലഞ്ച് സംഘടിപ്പിക്കുകയാണ്.
                                                    {"\n"}
                                                    500 രൂപ നൽകി ഒരു കിലോ ഗുണമേന്മയുള്ള ഈത്തപ്പഴം താങ്കളും സഹപ്രവർത്തകരും കൈപ്പറ്റി ഈ സദുദ്യമത്തിൽ പങ്കാളിയാവണമെന്നും, വേദനയുടെ ലോകത്തെ ഒറ്റപ്പെട്ടവരെ ചേർത്തുപിടിക്കുന്ന ഈ സദുദ്യമത്തെ പ്രാർത്ഥന കൊണ്ടും പിന്തുണ കൊണ്ടും ചേർത്തുപിടിക്കണം എന്നും അഭ്യർത്ഥിക്കുന്നു.
                                                </p>
                                            </div>
                                        </motion.div>
                                    )}
